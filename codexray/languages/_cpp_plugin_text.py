"""Node text extraction helpers for the C++ extractor."""
...
def get_node_text_optimized(
    ...
    return _fallback_node_text(node, content_lines, node_text_cache, cache_key)
...
def _fallback_node_text(
    ...
    try:
        result = _fallback_node_text_uncached(
            node.start_point,
            node.end_point,
            content_lines,
        )
...
def _fallback_node_text_uncached(
