...
uv run python -m codexray examples/BigService.java --table full

# Use query-key only:
uv run python -m codexray examples/BigService.java --query-key methods

# Use query-key with filter:
uv run python -m codexray examples/BigService.java --query-key methods --filter "name=main"

# Invalid combination (will cause error):
uv run python -m codexray examples/BigService.java --table full --query-key methods
"""
