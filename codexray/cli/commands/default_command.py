...
class DefaultCommand(BaseCommand):
    ...
    async def execute_async(self, language: str) -> int:
        ...
        output_info("  codexray file.java --query-key class --format json")
        output_info("  codexray file.java --advanced --format json")
        output_info("  codexray file.java --table json")
        return 1
